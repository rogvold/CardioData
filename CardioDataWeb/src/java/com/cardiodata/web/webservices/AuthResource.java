...
public class AuthResource {
    ...
    private String makeFacebookProofPostRequest(String accessToken, String proof) throws CardioDataException{
        try {
            ...
            throw new CardioDataException("facebook auth fail", ResponseConstants.NOT_AUTHORIZED_CODE);
        }
      }
